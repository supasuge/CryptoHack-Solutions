...
# Description: Here's my secure search enginer, which will only search for hosts in its trusted certificate cache.
# Connection: nc socket.cryptohack.org 13382

## Directions: 
# - Explain code
# - Outline the solution to get the flag
# - provide boilerplate code using pwntools to connect to the remote serivce and solve the challenge
